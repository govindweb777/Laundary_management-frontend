...
//   return (
//     <div className="max-w-3xl p-6 rounded-lg font-poppins md:ml-12 lg:ml-48">
//       <h2 className="text-lg font-semibold">Add Employee</h2>
//       <p className="text-gray-500 text-sm">list of people who are working here</p>
...
//             onChange={handleChange}
//             className="w-[910px] h-[125px] p-2 border rounded-lg"
//           />
//         </div>
//         <div className="flex justify-between mt-4">
//           <button className="bg-[#A6ABC8] text-[#333333] px-4 py-2 w-[142px] h-[43px] rounded-[15px] font-bold">Add</button>
          
//         </div>
//         <button className="bg-[#5A6ACF] text-white px-4 py-2 mt-1 w-[142px] h-[43px] rounded-[15px] font-bold ml-[850px]">Done</button>
