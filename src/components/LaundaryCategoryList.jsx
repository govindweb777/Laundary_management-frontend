  ...
  return (
    <div className="max-w-5xl mx-auto p-6 font-poppins">
      ...
      <div className="flex justify-between items-center">
        <h2 className="text-lg font-semibold">Laundary Category List</h2>
        <NavLink to="/new-laundary">
          <button className="flex items-center gap-3 px-4 py-2 bg-primary text-black rounded-lg hover:bg-secondary">
