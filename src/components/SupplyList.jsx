    ...
    <div className="relative max-w-5xl mx-auto p-6">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex justify-center items-start pt-10 z-10 mt-11 ml-56">
          <div className="max-w-3xl p-6 rounded-lg font-poppins bg-white z-30 relative w-full mx-4 shadow-lg">
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                <label className="font-semibold text-[#07187B]">Supply Name</label>
                <input type="text" name="supplyName" placeholder="Enter Supply Name" value={formData.supplyName} onChange={handleChange} className="w-full p-2 border rounded-lg" />
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-4">
              <div>
                <label className="font-semibold text-[#07187B]">Supply Category</label>
                <select name="supplyCategory" value={formData.supplyCategory} onChange={handleChange} className="w-full p-2 border rounded-lg">
                  <option>Enter Supply Category</option>
                </select>
              </div>
              <div>
                <label className="font-semibold text-[#07187B]">Supply Sub-Category</label>
                <select name="supplysubCategory" value={formData.supplysubCategory} onChange={handleChange} className="w-full p-2 border rounded-lg">
                  <option>Enter Supply Sub Category</option>
                </select>
              </div>
              <div>
      ...
      <div className={`relative z-0 ${showModal ? "blur-md" : ""}`}>
        <div className="flex justify-between items-center mb-2">
          <h2 className="text-lg font-poppins font-semibold text-[18px] leading-[20px] tracking-[0.5px]">Supply List</h2>
          <div className="flex gap-3">
            ...
            <button className="flex items-center gap-3 bg-primary text-black rounded-lg hover:bg-secondary" onClick={() => setShowModal(true)}>
              ...
              <span className="font-poppins text-sm font-light">Add Supply</span>
            </button>
